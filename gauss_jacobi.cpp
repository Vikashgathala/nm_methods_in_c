...
// Gauss-Jacobi Method function
void gaussJacobi(double A[N][N], double b[N], double x0[N], double tolerance, int maxIterations) {
...
int main() {
    ...
    // Applying Gauss-Jacobi Method
    gaussJacobi(A, b, x0, tolerance, maxIterations);
